...
export declare const InputBase: (<C = "input">(props: import("@mantine/utils").PolymorphicComponentProps<C, InputBaseProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
