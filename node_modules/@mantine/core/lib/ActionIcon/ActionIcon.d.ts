...
export declare const ActionIcon: (<C = "button">(props: import("@mantine/utils").PolymorphicComponentProps<C, ActionIconProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
