...
export declare const ColorSwatch: (<C = "div">(props: import("@mantine/utils").PolymorphicComponentProps<C, ColorSwatchProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
