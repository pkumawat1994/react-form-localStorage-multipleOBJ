...
export declare const Input: (<C = "input">(props: import("@mantine/utils").PolymorphicComponentProps<C, InputProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & {
