...
export declare const Avatar: (<C = "div">(props: import("@mantine/utils").PolymorphicComponentProps<C, AvatarProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & {
