...
export declare const NavLink: (<C = "button">(props: import("@mantine/utils").PolymorphicComponentProps<C, NavLinkProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
