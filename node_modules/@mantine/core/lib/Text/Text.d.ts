...
export declare const Text: (<C = "div">(props: import("@mantine/utils").PolymorphicComponentProps<C, TextProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
