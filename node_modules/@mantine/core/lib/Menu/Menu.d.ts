...
export declare namespace Menu {
    ...
    var Item: (<C = "button">(props: import("@mantine/utils").PolymorphicComponentProps<C, import("./MenuItem/MenuItem").MenuItemProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
