...
export declare const Highlight: (<C = "div">(props: import("@mantine/utils").PolymorphicComponentProps<C, HighlightProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
