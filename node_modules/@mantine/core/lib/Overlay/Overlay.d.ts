...
export declare const Overlay: (<C = "div">(props: import("@mantine/utils").PolymorphicComponentProps<C, OverlayProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Record<string, never>;
